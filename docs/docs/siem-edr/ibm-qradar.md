...
5. When it's done setting up, you will be prompted to log in. The username is 'root' and there is no initial password.
...
To view your Log Sources, log in to the QRadar console, then click on 'Admin' > 'Data Sources' > 'Log Sources'.
...
2. The .msi installer must be executed from a PowerShell admin terminal:
...
3. Log in to the QRadar console. Click on the 'Admin' tab > 'System and License Management'.
...
8. Click on the 'Admin' tab > 'System and License Management' > 'License Pool Management'.
