...
<div style="display: flex; justify-content: space-between;">
  <div><em>Zolon Tech, Inc.</em></div>
  <div><em>2025 – Present</em></div>
</div>
<div style="text-align: right;"><em>Herndon, VA</em></div>

- Take full ownership of assigned projects with minimal supervision, effectively managing setup, configuration, and troubleshooting, improving deployment time by 20%.  
...
- Conduct self-directed research and hands-on testing of new technologies, accelerating evaluation cycles by 15%.  
...
### Internship and Homelab Projects
...
??? note "Expand ⤵︎"
    ...
    <div style="display: flex; justify-content: space-between;">
      <div><em>Homelab/Internship</em></div>
    ...
    - Use `Docker` for containerized applications, storage mapping, and device passthrough configurations.  
    - Design `Docker Compose` `YAML` files, manage and monitor containers through `Portainer` and `Proxmox`.  
    - Configure `Proxmox` virtual machines for efficient resource segmentation within the home network.  
    - Create automation scripts in `Bash` (e.g., patching, startup services, text processing).  
    - Strengthen troubleshooting skills by identifying root causes via log analysis and error research; document solutions.  
    - Deploy and maintain a `MkDocs Material` documentation site via `Cloudflare Pages` connecting `GitHub` repo for automated builds and global distribution.  

    #### Networking and Zero-Trust Architecture

    <div style="display: flex; justify-content: space-between;">
      <div><em>Internship/Homelab</em></div>
      <div><em>2025 – Present</em></div>
    </div>
    ...
    - Implement `AdGuard` DNS server to block ads and trackers, with custom local DNS rewrites for internal services.
    ...
    - Deploy open-source OAuth provider (`Authentik`) for secure sign-in management for Portainer and Proxmox dashboards.  
    ...
    - Install and configure `IBM QRadar CE` on `VirtualBox`; ingest logs from Windows/Linux systems via `WinCollect` and `rsyslog`.  
    ...
    - Install `CrowdStrike Falcon` EDR sensors on Windows, Linux, and Android devices.  
    ...
    - Maintain `RustDesk` remote desktop server for secure server management.
...
| **Virtualization & Containers**| Windows Server 2019, Hyper-V, VirtualBox, VMware, Proxmox, Docker                                   |
| **Cloud Platforms & Hosting**  | DigitalOcean VPS, Cloudflare, Cloud Security Fundamentals                                           |
| **Network & Security**      | Zero-Trust Architecture, VPNs, TCP/IP, DNS, TLS/SSL, Tailscale, WireGuard, Nginx/Caddy, Pi-hole/AdGuard, Firewall Configuration, Network Segmentation |
| **Network Analysis**           | Wireshark, Nmap                                                                                     |
| **EDR/SIEM**                  | IBM QRadar, Wazuh, CrowdStrike Falcon                                                               |
| **Vulnerability & Compliance**| Nessus, OpenVAS, SCAP/OSCAP, DISA STIGs, CIS Benchmarks, NIST, MITRE ATT&CK                           |
| **Identity and Access Management (IAM)** | Cisco Duo, Authentik                                                                           |
| **CI/CD & Automation**            | GitHub Actions, Cloudflare Pages, Docker, Bash scripting, Automated Builds and Deployments          |
| **Incident Response & Threat Detection** | Security Incident Handling, Log Analysis, Threat Modeling                                     |
| **Security Frameworks & Standards**| NIST, GDPR, HIPAA                                                     |
| **Open Source Intelligence (OSINT)** | VirusTotal, Any.Run, Who.is, Webroot BrightCloud, Authentic8 Silo                                 |
| **Office & Productivity Tools**| Microsoft Office 365, Google Workspace                                                             |
| **Soft Skills**                | Documentation, Troubleshooting, Research, Communication, Team Collaboration                           |
...
<div style="display: flex; justify-content: space-between;">
  <div><strong>CompTIA Security+</strong></div>
  <div><em>Expected 11/2025</em></div>
</div>  
*V7 (In Progress)*

<div style="display: flex; justify-content: space-between;">
  <div><strong>CompTIA A+</strong></div>
  <div><em>2024</em></div>
</div>  
*220-1101, 220-1102*
...
<div style="display: flex; justify-content: space-between;">
  <div><strong>Old Dominion University</strong></div>
  <div><em>Norfolk, VA 2022</em></div>
</div>  
_Bachelor of Science in Cybersecurity_ (GPA: 3.89)  

<div style="display: flex; justify-content: space-between;">
  <div><strong>Tidewater Community College</strong></div>
  <div><em>Virginia Beach, VA 2020</em></div>
</div>  
_Associate of Science in General Studies_ (GPA: 3.69)  

### Academic Projects


<div style="display: flex; justify-content: space-between;">
  <div><strong>Cybersecurity Assessment</strong></div>
  <div><em>2022</em></div>
</div>  
...
<div style="display: flex; justify-content: space-between;">
  <div><strong>Cybersecurity Labs</strong></div>
  <div><em>2022</em></div>
</div>  
*Old Dominion University*
...
<div style="display: flex; justify-content: space-between;">
  <div><strong>Advanced Network and Server Configuration</strong></div>
  <div><em>2022</em></div>
</div>  
*Old Dominion University*
...
<div style="display: flex; justify-content: space-between;">
  <div><strong>Network Infrastructure Design</strong></div>
  <div><em>2021</em></div>
</div>  
*Old Dominion University*
...
<div style="display: flex; justify-content: space-between;">
  <div><strong>Network Case Analysis</strong></div>
  <div><em>2021</em></div>
</div>  
*Old Dominion University*
